...
import com.wandrell.example.mule.swss.generated.samples.GetSampleResponse.Return;
import com.wandrell.example.mule.swss.generated.samples.SampleEndpoint;

@Service
@Singleton
public final class WSDLFirstSampleEndpoint implements SampleEndpoint {

	@Autowired
	private JPASampleRepository repository;

	public WSDLFirstSampleEndpoint() {
		super();
	}
	...
	@Override
	public final Return getSample(final float cod1, final float cod2) {
