...
@ContextConfiguration(TestContextConfig.CLIENT_SECURE_CONSUMER)
public final class ITSecureConsumerLocalClientFlow extends FunctionalTestCase {

	@Value("${client.secure.consumer.encrypted.flow}")
	private String encryptedFlow;
	private final String expectedResult;
	@Resource(name = "configFiles")
	private String[] files;
	@Value("${client.secure.consumer.signed.flow}")
	private String signedFlow;
	@Value("${client.secure.consumer.username.flow}")
	...
	public ITSecureConsumerLocalClientFlow() {
		super();
	}
